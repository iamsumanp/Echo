...
class WindowManager<Content: View>: NSObject, NSWindowDelegate {
    ...
    private func setupWindow() {
        ...
        window.setFrameAutosaveName("ClipboardManagerWindowFrame")
        ...
        // Center initially only if no saved frame exists
        if !window.setFrameUsingName("ClipboardManagerWindowFrame") {
            window.center()
        }
    }
